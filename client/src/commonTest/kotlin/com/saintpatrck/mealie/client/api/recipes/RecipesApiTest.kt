...
class RecipesApiTest : BaseApiTest() {
    ...
    @Test
    fun `getRecipe should deserialize correctly`() = runTest {
    ...
    @Test
    fun `updateRecipe should deserialize correctly`() = runTest {
        createTestMealieClient(responseJson = RECIPE_JSON)
            .recipesApi
            .updateRecipe(
                slug = "mock-slug",
    ...
    @Test
    fun `patchRecipe should deserialize correctly`() = runTest {
        createTestMealieClient(responseJson = RECIPE_JSON)
            .recipesApi
            .patchRecipe(
                slug = "some-slug",
